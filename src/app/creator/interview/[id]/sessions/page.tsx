...
export default function InterviewSessionsPage() {
  ...
  return (
    <div>
      <Link href={`/creator/interview/${interviewId}`} className="mb-4 inline-flex items-center gap-1.5 text-[13px] text-ht-text-secondary hover:text-ht-text transition-colors">
        <ArrowLeft className="h-4 w-4" /> Retour à l&apos;interview
      </Link>
